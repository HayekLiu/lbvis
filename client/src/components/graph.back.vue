...
export default {
  ...
  methods: {
    init(){
      ...
      self.init_rounds = [1, 2, 3, 4] // filtered rounds from overview plot
    ...
    drawGraph(nodes, max_nodes, links, dists, transfers) 
    {
      ...
      var margin = {top: 65, right: 15, bottom: 120, left: 30}
      ...
      self.initGraphSettings(16, 16, 0.65)
